...
public class US_009 {
    ...
    public void tc_01(){
        ...
        // 5- Uyarı mesajının gözüktüğü doğrulanıyor
        Assert.assertTrue(tawUserHomePage.newsletterEmailSubmitAlertMessage.isDisplayed());

        // 6- Submit butonuna bastıktan sonra çıkan mesajın içeriği okunur
        String actualEmailAlertResut = tawUserHomePage.newsletterEmailSubmitAlertMessage.getText();

        // 7- E-posta adresi zaten kayıtlı ise veya yeni kayıt yapıldıysa iki farklı mesajın içerği test edilir
